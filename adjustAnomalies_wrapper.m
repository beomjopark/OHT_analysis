...
%               plotMeanFieldAdjustedAbsolute(month, meanTag, kernelType, typeTag, responseTag, verticalSelection, dataYear, windowSize, minNumberOfObs, is2step, fluxType, eqBorder, nAdjust);
            ...
            adjustResidual(month, kernelType, meanTag, typeTag, responseTag, verticalSelection, dataYear, windowType, windowSize, minNumberOfObs, is2step, true, isStandardize, [], [], nAdjust);
           ...
           divideDataToMonthsSeason(meanTag, typeTag, responseTag, verticalSelection, dataYear, windowType, windowSize, minNumberOfObs, is2step, [], [], true, false, nAdjust+1, iterEM, isFullMonth);
            ...
            srcMaskName = ['./Data/dataMask',verticalSelection,dataYear,[],[],'_',num2str(minNumberOfObs),windowTypeTag,'_w',num2str(windowSizeMean),'.mat'];
            descMaskName = ['./Data/dataMask',verticalSelection,dataYear,'Adjusted',[],'_',num2str(minNumberOfObs),windowTypeTag,'_w',num2str(windowSizeMean),'.mat'];
