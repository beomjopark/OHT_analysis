...
if isTarget
  saveName = ['./Data/targetTempProf','ESA','PchipPotTemp',num2str(10),'_',num2str(900),'_',num2str(targetYear),'.mat'];
else
  saveName = ['./Data/intESAProf','PchipPotTemp','Relative10',dataYear,adjustTag,absoluteTag,'Filtered_',num2str(minNumberOfObs),windowTypeTag,'_w',num2str(windowSizeMean),'Year',num2str(targetYear),'.mat'];
end
save(saveName,...
    'NNgridIdx', 'distGap');
